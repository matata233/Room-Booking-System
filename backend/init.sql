...
VALUES (109, 3, 1, '100', 'Hollyburn', 8, TRUE),
       ...
       (124, 3, 3, '305', NULL, 4, TRUE),
       (125, 3, 3, '306', NULL, 4, TRUE),
...
VALUES (152, 4, 1, '100', 'Interview Room', 3, TRUE),
       ...
       (156, 4, 1, '401', NULL, 10, TRUE),
       (157, 4, 1, '402', NULL, 20, TRUE),
       (158, 4, 1, '403', NULL, 4, TRUE),
       (159, 4, 1, '404', NULL, 12, TRUE),
       (160, 4, 2, '102', NULL, 4, TRUE),
       (161, 4, 2, '103', NULL, 6, TRUE),
       (162, 4, 2, '200', NULL, 4, TRUE),
       (163, 4, 2, '300', NULL, 8, TRUE),
       (164, 4, 2, '301', NULL, 10, TRUE),
       (165, 4, 3, '100', NULL, 4, TRUE),
       (166, 4, 3, '101', NULL, 4, TRUE),
       (167, 4, 3, '103', NULL, 8, TRUE),
       (168, 4, 3, '201', NULL, 4, TRUE),
       (169, 4, 3, '203', NULL, 12, TRUE),
       (170, 4, 3, '301', NULL, 14, TRUE),
       (171, 4, 3, '400', NULL, 14, TRUE),
       (172, 4, 4, '100', NULL, 4, TRUE),
       (173, 4, 4, '101', NULL, 4, TRUE),
       (174, 4, 4, '103', NULL, 8, TRUE),
       (175, 4, 4, '201', NULL, 4, TRUE),
       (176, 4, 4, '203', NULL, 14, TRUE),
       (177, 4, 4, '301', NULL, 14, TRUE),
       (178, 4, 4, '400', NULL, 14, TRUE),
       (179, 4, 5, '100', NULL, 4, TRUE),
       (180, 4, 5, '201', NULL, 4, TRUE),
       (181, 4, 5, '203', NULL, 12, TRUE),
       (182, 4, 5, '301', NULL, 14, TRUE),
       (183, 4, 5, '400', NULL, 14, TRUE);
...
INSERT INTO rooms (room_id, building_id, floor, code, name, seats, is_active)
VALUES (184, 5, 1, '308', NULL, 4, TRUE),
       (185, 5, 1, '309', NULL, 10, TRUE),
       (186, 5, 1, '310', NULL, 20, TRUE),
       (187, 5, 1, '311', NULL, 4, TRUE),
       (188, 5, 1, '403', NULL, 4, TRUE),
       (189, 5, 1, '404', NULL, 8, TRUE),
       (190, 5, 2, '307', NULL, 10, TRUE),
       (191, 5, 2, '308', NULL, 20, TRUE),
       (192, 5, 2, '309', NULL, 4, TRUE),
       (193, 5, 2, '403', NULL, 4, TRUE),
       (194, 5, 2, '404', NULL, 10, TRUE),
       (195, 5, 3, '321', NULL, 4, TRUE),
       (196, 5, 3, '327', NULL, 12, TRUE),
       (197, 5, 3, '328', NULL, 4, TRUE),
       (198, 5, 3, '329', NULL, 12, TRUE),
       (199, 5, 3, '332', 'Training Room Combinable', 30, TRUE),
       (200, 5, 3, '333', 'Training Room Combinable', 30, TRUE),
       (201, 5, 3, '407', NULL, 4, TRUE),
       (202, 5, 3, '408', NULL, 12, TRUE),
       (203, 5, 3, '409', NULL, 4, TRUE),
       (204, 5, 3, '410', NULL, 12, TRUE),
       (205, 5, 3, '420', NULL, 4, TRUE),
       (206, 5, 4, '300', NULL, 10, TRUE),
       (207, 5, 4, '309', NULL, 10, TRUE),
       (208, 5, 4, '313', NULL, 4, TRUE),
       (209, 5, 4, '315', NULL, 16, TRUE),
       (210, 5, 4, '316', NULL, 12, TRUE),
       (211, 5, 4, '400', NULL, 10, TRUE),
       (212, 5, 4, '413', NULL, 4, TRUE),
       (213, 5, 4, '414', NULL, 4, TRUE),
       ...
       (218, 5, 5, '306', NULL, 4, TRUE),
       (219, 5, 5, '313', NULL, 12, TRUE),
       (220, 5, 5, '314', NULL, 12, TRUE),
       (221, 5, 5, '400', NULL, 16, TRUE),
       (222, 5, 5, '401', NULL, 20, TRUE),
       (223, 5, 5, '420', NULL, 4, TRUE),
       (224, 5, 5, '421', NULL, 4, TRUE),
       (225, 5, 5, '422', NULL, 8, TRUE),
       ...
       (229, 5, 6, '303', NULL, 4, TRUE),
       (230, 5, 6, '304', NULL, 4, TRUE),
       (231, 5, 6, '306', NULL, 4, TRUE),
       (232, 5, 6, '314', NULL, 12, TRUE),
       (233, 5, 6, '315', NULL, 4, TRUE),
       (234, 5, 6, '316', NULL, 4, TRUE),
       (235, 5, 6, '400', NULL, 8, TRUE),
       (236, 5, 6, '401', NULL, 18, TRUE),
       (237, 5, 6, '419', 'Training Room', 30, TRUE),
       (238, 5, 7, '300', NULL, 20, TRUE),
       (239, 5, 7, '305', NULL, 14, TRUE),
       (240, 5, 7, '312', NULL, 8, TRUE),
       (241, 5, 7, '313', NULL, 12, TRUE),
       (242, 5, 7, '314', NULL, 12, TRUE),
       (243, 5, 7, '401', NULL, 4, TRUE),
       (244, 5, 7, '402', NULL, 14, TRUE),
       (245, 5, 7, '403', NULL, 10, TRUE),
       (246, 5, 7, '404', NULL, 4, TRUE),
       (247, 5, 7, '405', NULL, 4, TRUE),
       (248, 5, 7, '424', NULL, 4, TRUE),
       (249, 5, 8, '300', NULL, 20, TRUE),
       (250, 5, 8, '312', NULL, 8, TRUE),
       (251, 5, 8, '313', NULL, 12, TRUE),
       (252, 5, 8, '314', NULL, 12, TRUE),
       (253, 5, 8, '401', NULL, 4, TRUE),
       (254, 5, 8, '402', NULL, 14, TRUE),
       (255, 5, 8, '403', NULL, 10, TRUE),
       (256, 5, 8, '404', NULL, 4, TRUE),
       (257, 5, 8, '405', NULL, 4, TRUE),
       (258, 5, 8, '424', NULL, 4, TRUE),
       (259, 5, 9, '300', NULL, 20, TRUE),
       (260, 5, 9, '305', NULL, 14, TRUE),
       (261, 5, 9, '312', NULL, 8, TRUE),
       (262, 5, 9, '313', NULL, 12, TRUE),
       (263, 5, 9, '314', NULL, 12, TRUE),
       (264, 5, 9, '401', NULL, 4, TRUE),
       (265, 5, 9, '402', NULL, 14, TRUE),
       (266, 5, 9, '403', NULL, 10, TRUE),
       (267, 5, 9, '404', NULL, 4, TRUE),
       (268, 5, 9, '405', NULL, 4, TRUE),
       (269, 5, 9, '424', NULL, 4, TRUE),
       (270, 5, 10, '300', NULL, 20, TRUE),
       (271, 5, 10, '312', NULL, 8, TRUE),
       (272, 5, 10, '313', NULL, 12, TRUE),
       (273, 5, 10, '314', NULL, 12, TRUE),
       (274, 5, 10, '401', NULL, 4, TRUE),
       (275, 5, 10, '402', NULL, 14, TRUE),
       (276, 5, 10, '403', NULL, 10, TRUE),
       (277, 5, 10, '404', NULL, 4, TRUE),
       (278, 5, 10, '405', NULL, 4, TRUE),
       (279, 5, 10, '424', NULL, 4, TRUE),
       (280, 5, 11, '300', NULL, 20, TRUE),
       (281, 5, 11, '314', NULL, 12, TRUE),
       (282, 5, 11, '403', NULL, 10, TRUE),
       (283, 5, 11, '404', NULL, 4, TRUE);
...
INSERT INTO rooms (room_id, building_id, floor, code, name, seats, is_active)
VALUES (284, 6, 1, '100', NULL, 18, TRUE),
       (285, 6, 1, '101', NULL, 18, TRUE),
       (286, 6, 1, '102', NULL, 4, TRUE),
       (287, 6, 1, '103', NULL, 4, TRUE),
       (288, 6, 1, '104', NULL, 4, TRUE),
       (289, 6, 1, '105', NULL, 14, TRUE),
       (290, 6, 1, '406', NULL, 10, TRUE),
       (291, 6, 2, '100', NULL, 18, TRUE),
       (292, 6, 2, '101', NULL, 18, TRUE),
       (293, 6, 2, '102', NULL, 4, TRUE),
       (294, 6, 2, '103', NULL, 4, TRUE),
       (295, 6, 2, '104', NULL, 4, TRUE),
       (296, 6, 2, '105', NULL, 14, TRUE),
       (297, 6, 2, '406', NULL, 10, TRUE),
...
INSERT INTO rooms (room_id, building_id, floor, code, name, seats, is_active)
VALUES (339, 7, 1, '007.A', NULL, 10, TRUE),
       (340, 7, 1, '007.B', NULL, 2, TRUE),
       (341, 7, 1, '007.C', NULL, 2, TRUE),
       (342, 7, 7, '007.D', NULL, 2, TRUE),
...
VALUES (1, 'bbrown5888', 'Bob', 'Brown', 'bbrown5888@example.com', 1, 4, 105, 'staff', TRUE),
       (2, 'cdavis1530', 'Charlie', 'Davis', 'cdavis1530@example.com', 2, 1, 101, 'admin', FALSE),
       (3, 'djohnson5652', 'Diana', 'Johnson', 'djohnson5652@example.com', 3, 1, 100, 'admin', FALSE),
       (4, 'gdavis3737', 'George', 'Davis', 'gdavis3737@example.com', 4, 2, 100, 'staff', TRUE),
       (5, 'fdavis3529', 'Fiona', 'Davis', 'fdavis3529@example.com', 5, 2, 102, 'staff', TRUE),
       (6, 'hmiller1868', 'Hannah', 'Miller', 'hmiller1868@example.com', 6, 3, 105, 'admin', TRUE),
       (7, 'hgarcia1209', 'Hannah', 'Garcia', 'hgarcia1209@example.com', 7, 3, 105, 'admin', FALSE),
       (8, 'cgarcia7408', 'Charlie', 'Garcia', 'cgarcia7408@example.com', 1, 2, 104, 'staff', TRUE),
       (9, 'dbrown5140', 'Diana', 'Brown', 'dbrown5140@example.com', 2, 3, 101, 'staff', TRUE),
       (10, 'dmiller5815', 'Diana', 'Miller', 'dmiller5815@example.com', 3, 1, 104, 'admin', TRUE),
